...
#ifndef LIBLINEAR_TEST_SOLVER_ADMM2_H
#define LIBLINEAR_TEST_SOLVER_ADMM2_H
...
{
	public:
	  Solver_ADMM2(const problem *prob, int nr_class, double C, double eps = 1e-10, \
	   int max_iter = 1000, \
...
#endif //LIBLINEAR_TEST_SOLVER_ADMM2_H
