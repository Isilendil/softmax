...
)
{
    ...
    Objective.alpha_list = alpha_list;
    Objective.q = q;
    Objective.norm = norm;
    Objective.C = C;
    Objective.yi = yi;
...
Version 1.3 Change:
    1. In the line search, lines 5077 and 5413, change "else" to
       "else if ( aj < BLGZERO )"
*/
